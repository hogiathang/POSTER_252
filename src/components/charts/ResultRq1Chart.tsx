    ...
    return (
        <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 24, right: 24, left: 0, bottom: 20 }} barCategoryGap="25%">
                    ...
                    <Bar dataKey="Static_SFR" name="Static_SFR" fill={COLORS.staticSfr} radius={[4, 4, 0, 0]}>
                        <LabelList dataKey="Static_SFR" position="top" offset={8} formatter={(value: number) => `${value.toFixed(1)}%`} style={{ fill: '#111827', fontSize: 11, fontWeight: 600 }} />
                    </Bar>
                    <Bar dataKey="Taint_SFR" name="Taint_SFR" fill={COLORS.taintSfr} radius={[4, 4, 0, 0]}>
                        <LabelList dataKey="Taint_SFR" position="top" offset={8} formatter={(value: number) => `${value.toFixed(1)}%`} style={{ fill: '#111827', fontSize: 11, fontWeight: 600 }} />
                    </Bar>
                </BarChart>
            </ResponsiveContainer>
        </div>
